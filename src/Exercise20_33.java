...
public class Exercise20_33 extends JApplet {
  ...
  public static void main(String[] args) {
    JFrame frame = new JFrame("Knight's Tour Animation");
    Exercise20_33 kp = new Exercise20_33();
    ...
    protected void paintComponent(Graphics g) {
      ...
      if (moveHistory != null && moveHistory.size() > 0) {
        ...
        if (moveHistory.size() > 0) {
          p2 = (Point)moveHistory.get(index - 1);
          g.drawImage(knightImage, p2.x * getWidth() / SIZE, p2.y * getHeight()
            / SIZE, getWidth() / SIZE, getHeight() / SIZE, this);
        }
      }
    }
