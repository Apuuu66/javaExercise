...
public class Exercise34_9 extends JApplet implements ActionListener {
  ...
  public static void main(String[] args) {
    Exercise34_9 applet = new Exercise34_9();
    JFrame frame = new JFrame();
    frame.setTitle("Exercise34_9: Play against the computer");
