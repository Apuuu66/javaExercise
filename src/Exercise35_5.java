...
public class Exercise35_5 extends JApplet {
  // Create a JSpinner
  private JSpinner spinner =
    new JSpinner(new ReverseSpinnerNumberModel());
  ...
  public static void main(String[] args) {
    ...
    Exercise35_5 applet = new Exercise35_5();
...
class ReverseSpinnerNumberModel extends SpinnerNumberModel {
  private int value = 2;
