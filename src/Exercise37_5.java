...
public class Exercise37_5 extends JApplet {
  private JTextField jtfTableName = new JTextField(9);
...
//     "scott", "tiger");
  ...
  public static void main(String[] args) {
    Exercise37_5 applet = new Exercise37_5();
    JFrame frame = new JFrame();
    frame.setTitle("Exercise37_5");
