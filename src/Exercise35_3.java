...
public class Exercise35_3 extends JApplet {
  ...
  public Exercise35_3() {
    ...
    // Register and create a listener for spinnerDate
    spinnerDate.addChangeListener(new ChangeListener() {
      public void stateChanged(javax.swing.event.ChangeEvent e) {
        // Get current day, month, and year in int
        int day = ((Date)spinnerDate.getValue()).getDate();
        int month = ((Date)spinnerDate.getValue()).getMonth();
        int year = ((Date)spinnerDate.getValue()).getYear();

        // Set a new date in the date spinner
        System.out.println("day is " + day + " month is " + month +
          " year is " + year);
        spinnerDay.setValue(new Integer(day));
        spinnerMonth.setValue(monthNames[month]);
        spinnerYear.setValue(new Integer(year + 1900));
      }
    });
  }
  ...
  public static void main(String[] args) {
    ...
    Exercise35_3 applet = new Exercise35_3();
