...
public class Exercise26_13 extends JApplet {
  private BinaryTree<Integer> tree = new BinaryTree<Integer>();
  
  public Exercise26_13() {
    tree.insert(50);
    tree.insert(25);
    tree.insert(75);
    tree.insert(12);
    ...
    add(new BinaryTreeSearchAnimation(tree));
  }
  
  public static void main(String[] args) {
    JFrame frame = new JFrame("Exercise25_13");
    JApplet applet = new Exercise26_13();
    frame.add(applet);
...
class BinaryTreeSearchAnimation extends JPanel {
  ...
  public BinaryTreeSearchAnimation(BinaryTree<Integer> tree) {
    this.tree = tree;
  ...
  Timer timer = new Timer(1000, new AnimationListener());
