// Exercise30_5.java: Display stock quote
import javax.swing.*;
...
public class Exercise30_5 extends JApplet implements MouseListener, MouseMotionListener {
  // isStandalone: the program runs as an application if true
  ...
  // Main method: New to Exercise 15.6
  public static void main(String[] args) {
    ...
    Exercise30_5 applet = new Exercise30_5();

    // New to Exercise 15.6
  ...
  public void init() {
    ...
    redImage =
      Toolkit.getDefaultToolkit().getImage(
        getClass().getResource("redTicker.gif"));

    blackImage =
      Toolkit.getDefaultToolkit().getImage(
        getClass().getResource("blackTicker.gif"));
    ...
    tickerAudio = Applet.newAudioClip
      (getClass().getResource("Ticker.au"));
    tickerAudio.loop();
  }
  ...
  public void getDataFromURL() {
    ...
    try {
        URL url = this.getClass().getResource("Exercise30_5.txt");
      ...
      for (int j = 0; j < 7 ; j++) {
        ...
        String indexTime = st.nextToken();
        String indexValue = st.nextToken();
        String indexChange = st.nextToken();

        indexArray[j] = indexName + "  " + indexTime;
        valueArray[j] = indexValue + "  " + indexChange;

        changeDbl = Double.valueOf(indexChange).doubleValue();
